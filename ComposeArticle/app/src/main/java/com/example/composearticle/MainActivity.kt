                ...
                Surface(
                    ...
                    Article("Jetpack Compose tutorial",
                        ...
                        "In this tutorial, you build a simple UI component with declarative functions." +
                                ...
                                " define your app\\'s UI programmatically because they let you describe how it should look" +
...
@Composable
fun Article(header: String, firstParagraph: String, secondParagraph: String,  modifier: Modifier = Modifier) {
    Column(
